...
import { ArrowLeft, Check, ChevronRight, ShoppingCart, Trash2, FileText, Copy, Package, Thermometer, Zap, Award, Filter, Wrench, CheckCircle2, Search, Loader2, Crown, Droplets, Download, Save, X } from "lucide-react";
...
export default function ProposalBuilder() {
  ...
  const handleSaveProposal = () => {
    ...
    const quoteTitle = `${customerNameToUse} — ${new Date().toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}`;
      ...
      <header className="sticky top-0 z-50 bg-card border-b border-border shadow-sm">
        <div className="flex items-center justify-between p-3 sm:p-4">
          <div className="flex items-center space-x-2 sm:space-x-3 min-w-0 flex-1">
            ...
            />
            <span className="text-sm sm:text-base font-semibold truncate">Proposal Builder</span>
          </div>
      ...
      <Dialog open={quoteDialogOpen} onOpenChange={setQuoteDialogOpen}>
        <DialogContent className="sm:max-w-3xl h-[90vh] max-h-[90vh] p-0 overflow-hidden flex flex-col">
          ...
          <ScrollArea className="flex-1 overflow-y-auto min-h-0 p-4 sm:p-6">
            ...
            {/* Proposal Notes - Rich Text Editor */}
              <div className="my-6">
          ...
          <div className="border-t p-4 bg-card shrink-0 flex-none">
            <div className="flex flex-col sm:flex-row gap-2">
              ...
              <Button
                ...
                disabled={cart.length === 0 || saveProposalMutation.isPending}
                className="flex-1 min-h-[44px]"
