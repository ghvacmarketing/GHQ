...
export default function CrmSettingsSalesbook() {
  ...
  const hasCustomEntries = bookmarks.length > 0;
  const activeEntries = hasCustomEntries
    ? displayBookmarks.map((bm) => ({ id: bm.id, label: bm.label, page: bm.pageNumber, isCustom: true as const }))
    : autoGeneratedToc.map((t, i) => ({ id: `auto-${i}`, label: t.label, page: t.page, isCustom: false as const }));
        ...
        {!hasCustomEntries && (
          <div className="bg-amber-50 border border-amber-200 rounded-lg px-4 py-3 mb-6">
            <p className="text-sm text-amber-800">
              <span className="font-medium">Auto-generated sections below.</span>{" "}
              Add a custom entry to take control of the directory. Once you add entries, only your custom entries will show in the salesbook.
            </p>
          </div>
        )}
