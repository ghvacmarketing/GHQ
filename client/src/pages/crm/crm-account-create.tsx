...
export default function CrmAccountCreate() {
  ...
  const [pmMainOfficePhoneError, setPmMainOfficePhoneError] = useState("");
  const [pmMainOfficeEmailError, setPmMainOfficeEmailError] = useState("");
  const [pmBillingApEmailError, setPmBillingApEmailError] = useState("");
                        ...
                        <Input
                          ...
                          onChange={(e) => {
                            ...
                            if (formatted && !validatePhone(formatted)) {
                              ...
                              setPmMainOfficePhoneError("");
                            }
                          }}
                          className={pmMainOfficePhoneError ? "border-red-500" : ""}
                          data-testid="input-main-office-phone"
                        />
                        {pmMainOfficePhoneError && <p className="text-sm text-red-500 mt-1">{pmMainOfficePhoneError}</p>}
                      </div>
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onBlur={() => {
                            if (formData.pmMainOfficeEmail && !validateEmail(formData.pmMainOfficeEmail)) {
                              setPmMainOfficeEmailError("Please enter a valid email (e.g., name@example.com)");
                            } else {
                              setPmMainOfficeEmailError("");
                            }
                          }}
                          className={pmMainOfficeEmailError ? "border-red-500" : ""}
                          data-testid="input-main-office-email"
                        />
                        {pmMainOfficeEmailError && <p className="text-sm text-red-500 mt-1">{pmMainOfficeEmailError}</p>}
                      </div>
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onBlur={() => {
                            if (formData.pmBillingApEmail && !validateEmail(formData.pmBillingApEmail)) {
                              setPmBillingApEmailError("Please enter a valid email (e.g., name@example.com)");
                            } else {
                              setPmBillingApEmailError("");
                            }
                          }}
                          className={pmBillingApEmailError ? "border-red-500" : ""}
                          data-testid="input-billing-ap-email"
                        />
                        {pmBillingApEmailError && <p className="text-sm text-red-500 mt-1">{pmBillingApEmailError}</p>}
