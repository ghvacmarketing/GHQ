...
const CrmTasksSimple = lazy(() => import("@/pages/crm/crm-tasks-simple"));
...
const MobileChecklists = lazy(() => import("@/pages/mobile/mobile-checklists"));
const MobileCallLog = lazy(() => import("@/pages/mobile/mobile-call-log"));
...
const MobileMail = lazy(() => import("@/pages/mobile/mobile-mail"));
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/mobile/checklists">{() => <MobileWrapper><MobileChecklists /></MobileWrapper>}</Route>
      <Route path="/mobile/call-log">{() => <MobileWrapper><MobileCallLog /></MobileWrapper>}</Route>
      ...
      <Route path="/mobile/mail">{() => <MobileWrapper><MobileMail /></MobileWrapper>}</Route>
