...
-   **Maintenance Agreements System**: Flexible billing frequencies (weekly, monthly, annual), configurable visits, regional reminders, and auto-creation from paid invoices.
...
-   **User Roles**: Granular CRM roles (Owner, Admin, Supervisor, Sales, Tech) with distinct access levels for desktop and mobile applications. Supervisor role has admin-level desktop access plus enhanced mobile with "All Techs / My Jobs" toggle to view all technicians' work orders. Only the Owner can change user roles.
