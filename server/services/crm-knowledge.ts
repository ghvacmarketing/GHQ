...
- For Custom Pricing quotes the Internal costs card shows the FULL costing waterfall exactly as the worksheet's Calculated Totals panel did at finalize: cost build-up (labor payroll, labor benefits, lines total, warranty reserve → direct cost), sell price, where the price goes (overhead / financing / commission / profit dollars), gross profit + margin %, crew days + GP per crew day, install type, and the discount math when a discount was given; service-mode quotes show their equivalent (parts subtotal, shrinkage, labor, sales tax, warranty reserve, GHVAC warranty coverage). Older quotes without a stored snapshot fall back to a simple sell − costs margin readout
